// importing all the events from crosstem crate. This crate provides all the events to handle the user input events
// such as handling keyboard & mouse
use crossterm::event::*;
// manipulate styles & attributes in the terminal with this import
use crossterm::style::*;
// The ClearType enum gives differnt terminal clearing options, like clearing the current line or whole
use crossterm::terminal::ClearType;
// cursor: to manipulate the cursor
// event: handling mouse & keyboard inputs
//execute: queue multiple terminal commands and execute them
...
// Constant variables that are shown at the start of the Welcome page
